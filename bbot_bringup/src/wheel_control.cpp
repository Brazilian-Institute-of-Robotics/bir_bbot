...
// Control table address XM430-W210
...
int main(int argc, char ** argv)
{
  ...
  dxl_comm_result = packetHandler->write1ByteTxRx(portHandler, DXL1_ID, ADDR_OPERATION_MODE, 1, &dxl_error);
  if (dxl_comm_result != COMM_SUCCESS) {
